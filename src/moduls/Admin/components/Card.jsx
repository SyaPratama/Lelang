...
const Card = ({
  ...
  return (
    <>
      <div className="max-w-full bg-white border border-gray-200 rounded-lg shadow-sm relative">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center">
            {!hideStatus && (
              <span className={`px-3 py-1 rounded-full text-white text-xs ${status === 'dibuka' ? 'bg-green-500' : 'bg-red-500'}`}>
            ...
            <div className="flex gap-2">
              {showMainButtons ? (
                <>
                  ...
                  <button
                    onClick={onEdit}
                    className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                  ...
                  <button
                    onClick={onDelete}
                    className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300"
                  >
                  ...
                  <button
                    onClick={onLelang}
                    className="flex items-center gap-1 px-3 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300"
                  >
