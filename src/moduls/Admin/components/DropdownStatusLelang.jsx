...
const DropdownStatusLelang = ({ onStatusChange, currentStatus }) => {
  ...
  return (
    <div className="relative inline-block text-left z-40">
      ...
      {dropdownOpen && (
        <div
          className="origin-top-right absolute right-0 mt-2 w-18 rounded-md shadow-lg  bg-white ring-1 ring-[#4365D1] ring-opacity-5 focus:outline-none "
          role="menu"
        ...
        >
          <div className="py-1" role="none">
            <button
              ...
              className="block p-1 w-full text-sm hover:bg-gray-100 hover:text-gray-900"
              role="menuitem"
            >
              Dibuka
            </button>
